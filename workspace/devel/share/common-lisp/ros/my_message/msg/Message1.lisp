...
(cl:defmethod cl:initialize-instance :after ((m <Message1>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Message1)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_message-msg:<Message1> is deprecated: use my_message-msg:Message1 instead.")))

(cl:ensure-generic-function 'text-val :lambda-list '(m))
(cl:defmethod text-val ((m <Message1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_message-msg:text-val is deprecated.  Use my_message-msg:text instead.")
  (text m))

(cl:ensure-generic-function 'number-val :lambda-list '(m))
(cl:defmethod number-val ((m <Message1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_message-msg:number-val is deprecated.  Use my_message-msg:number instead.")
  (number m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Message1>)))
  ...
  "6ae3591edb22917b11846d84bc548557")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Message1)))
  "Returns md5sum for a message object of type 'Message1"
  "6ae3591edb22917b11846d84bc548557")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Message1>)))
  ...
  (cl:format cl:nil "string text~%int32 number~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Message1)))
  "Returns full string definition for message of type 'Message1"
  (cl:format cl:nil "string text~%int32 number~%~%~%"))
